...
pomodoro_trayicon () {
    ...
    readonly MENU='Change task!bash -c change_task!emblem-default|Stop!bash -c "daemon stop"!process-stop|Reset!bash -c "daemon reset"!edit-redo|Quit!bash -c quit!application-exit'
    local state=
